...
class Register:
    def __init__(self,winregister):
        ...
        self.winregister.geometry('1600x1204+0+0')
        ...
        register_frame.place(x=500,y=290,width=550,height=385)
        ...
        title_frame.pack()
        registration_text=Label(title_frame,text='Registration/...../Page',font=("rockwell",30,"bold"),bd=5,borderwidth=13,bg='#7d1515',relief=RAISED)
        registration_text.pack()



        # Creating fields fro inputs
        register_frame.columnconfigure(0,weight=3)
        register_frame.columnconfigure(1,weight=3)
        
        user_name=Label(register_frame,text='USERNAME :-',font=("rockwell",14,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=12)
        user_name.grid(row=0,column=0,padx=0,pady=17)
        ...
        user_password=Label(register_frame,text='PASSWORD :-',font=("rockwell",14,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=12)
        user_password.grid(row=1,column=0,padx=0,pady=13)
        ...
        user_gender=Label(register_frame,text='GENDER :-',font=("rockwell",14,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=12)
        user_gender.grid(row=2,column=0,pady=13)
        
        user_gender_entry=ttk.Combobox(register_frame,textvariable=self.gender,width=22,font=("times new roman",13,"bold"))
        user_gender_entry['values']=('male','female','other' )
        # user_gender_entry.insert(0,'male or female')
        user_gender_entry.grid(row=2,column=1,padx=5,pady=5)
        
        user_age=Label(register_frame,text='AGE :-',font=("rockwell",14,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=12)
        user_age.grid(row=3,column=0,pady=13)
        ...
        user_number=Label(register_frame,text='MOBILE_NO :-',font=("rockwell",14,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=12)
        user_number.grid(row=4,column=0,pady=13)
        ...
        submit_button=Button(register_frame,text='SUBMIT',bd=6,borderwidth=9,bg='#5e6269',command=self.submit_data,width=15,font=("rockwell",14,"bold"))
    ...
    def submit_data(self):
        if self.username.get()=="" or self.password.get()=="" or self.gender.get()=="" or self.age.get()=="" or self.number.get()=="":
            ...
            try:
                 ...
                 cursor.execute("INSERT INTO PASSWORD VALUES(:1,:2,:3)",(u,p,user_id))
                 cursor.execute("INSERT INTO CUSTOMER (custid,username) VALUES (:u_id,:u_name)",u_id=user_id,u_name=u)
