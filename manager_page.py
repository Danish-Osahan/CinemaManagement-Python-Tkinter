...
class manage():
    def __init__(self,winmanager):
        ...
        title_frame.pack()
        registration_text=Label(title_frame,text='Movie/..../Managing',font=("rockwell",30,"bold"),bd=5,borderwidth=13,bg='#7d1515',relief=RAISED)
        ...
        movie_id=Label(f1,text='MOVIE ID :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_id.grid(row=0,column=0,padx=0,pady=14)

        movie_id_entry=Entry(f1,textvariable=self.movieid_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_id_entry.grid(row=0,column=1,padx=5,pady=5)

        movie_name=Label(f1,text='NAME :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_name.grid(row=1,column=0,padx=0,pady=8)

        movie_name_entry=Entry(f1,textvariable=self.moviename_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_name_entry.grid(row=1,column=1,padx=5,pady=5)

        movie_type=Label(f1,text='TYPE :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_type.grid(row=2,column=0,pady=8)
        
        movie_type_entry=Entry(f1,textvariable=self.movietype_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        # movie_type_entry.insert(0,'male or female')
        movie_type_entry.grid(row=2,column=1,padx=5,pady=5)
        
        release_date=Label(f1,text='RELEASE DATE :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        release_date.grid(row=3,column=0,pady=8)

        release_date_entry=Entry(f1,textvariable=self.movierdate,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        release_date_entry.grid(row=3,column=1,padx=5,pady=5)

        movie_actor=Label(f1,text='ACTOR :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_actor.grid(row=4,column=0,pady=8)

        movie_actor_entry=Entry(f1,textvariable= self.movieactor_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_actor_entry.grid(row=4,column=1,padx=5,pady=5)

        movie_actoress=Label(f1,text='ACTRESS :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_actoress.grid(row=5,column=0,pady=8)
 
        movie_actoress_entry=Entry(f1,textvariable= self.movieactress_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_actoress_entry.grid(row=5,column=1,padx=5,pady=5)
        
        movie_director=Label(f1,text='DIRECTOR :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_director.grid(row=6,column=0,pady=8)
 
        movie_director_entry=Entry(f1,textvariable=self.moviedirector_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_director_entry.grid(row=6,column=1,padx=5,pady=5)

        movie_length=Label(f1,text='LENGTH :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_length.grid(row=7,column=0,pady=8)
 
        movie_length_entry=Entry(f1,textvariable=self.movielength_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_length_entry.grid(row=7,column=1,padx=5,pady=5)

        movie_seats=Label(f1,text='SEATS :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_seats.grid(row=8,column=0,pady=8)
 
        movie_seats_entry=Entry(f1,textvariable=self.movieseats_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_seats_entry.grid(row=8,column=1,padx=5,pady=5)
        
        movie_theatre=Label(f1,text='THEATRE :-',font=("rockwell",12,"bold"),bd=5,relief=RAISED,bg='#6f747d',width=15)
        movie_theatre.grid(row=9,column=0,pady=8)
 
        movie_theatre_entry=Entry(f1,textvariable=self.movietheatre_var,width=30,relief=SUNKEN,bg='#7d1515',bd=5,fg='white',font=("rockwell",10,"bold"))
        movie_theatre_entry.grid(row=9,column=1,padx=5,pady=5)
        

        insert_button=Button(f1,text='INSERT',bd=6,borderwidth=6,bg='#ad1a1a',width=15,font=("rockwell",12,"bold"),command=self.add_data)
        insert_button.grid(row=10,column=0,padx=5,pady=10)

        update_button=Button(f1,text='UPDATE',bd=6,borderwidth=6,bg='#ad1a1a',width=15,font=("rockwell",12,"bold"),command=self.update_data)
        update_button.grid(row=10,column=1,padx=5,pady=20)

        delete_button=Button(f1,text='DELETE',bd=6,borderwidth=6,bg='#ad1a1a',width=15,font=("rockwell",12,"bold"),command=self.delete_data)
        delete_button.grid(row=11,column=0,padx=5,pady=5)

        clear_button=Button(f1,text='CLEAR',bd=6,borderwidth=6,bg='#ad1a1a',width=15,font=("rockwell",12,"bold"),command=self.clear_data)
        clear_button.grid(row=11,column=1,padx=5,pady=5)

        quit_buttom=Button(self.winmanager,text="QUIT AND GO BACK",bd=7,borderwidth=9,bg='#ad1a1a',width=22,font=("rockwell",14,"bold"),command=self.quit)
        ...
        style.configure("Treeview.Heading", font=("rockwell",15,"bold"),fieldbackground='#ad1a1a',background='#ad1a1a')
        style.configure("Treeview",background='#5e6269',fieldbackground='#5e6269',fieldforground="white",forground="white",font=("rockwell",13))
        ...
        self.Movie_Table.column("NAME",width=270)
        self.Movie_Table.column("TYPE",width=300)
        self.Movie_Table.column("RELEASE DATE",width=120)
        self.Movie_Table.column("HEROES",width=270)
        self.Movie_Table.column("HEROINES",width=250)
    ...
    def add_data(self):
        if self.movieid_var.get()=="" or self.moviename_var.get()==""or self.movietype_var.get()==""or self.movierdate.get()==""or self.movieactor_var.get()=="" or self.movieactress_var.get()=="" or self.moviedirector_var.get()=="" or self.movielength_var.get()=="" or self.movieseats_var.get()=="" or self.movietheatre_var.get()=="":
            ...
            try:
                ...
                cursor.execute("INSERT INTO  movie_earning(MOVIE_ID,MOVIE_NAME,total_earning) VALUES(:id,:nm,:er)",id=I,nm=N,er=price) 
    ...
    def update_data(self):
        if self.movieid_var.get()=="" or self.moviename_var.get()==""or self.movietype_var.get()==""or self.movierdate.get()==""or self.movieactor_var.get()=="" or self.movieactress_var.get()=="" or self.moviedirector_var.get()=="" or self.movielength_var.get()=="" or self.movieseats_var.get()=="" or self.movietheatre_var.get()=="":
            ...
            try:
                ...
                # cursor.execute("UPDATE MOVIE_EARNING SET MOVIE_NAME= :nm WHERE MOVIE_ID = :id",id=I)
                ...
                messagebox.showinfo("SUCCESS","RECORD UPDATED SUCCESFULLY",parent=self.winmanager)
                # if (a=='ok'):
                #     b=messagebox.askyesno("PERMISSION","GO BACK TO THE LOGIN PAGE")
                #     if(b=='yes'):
                #         self.winmanager.quit()
